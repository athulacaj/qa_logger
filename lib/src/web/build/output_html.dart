...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
<body>
  <div id="notification" style="display:none; position: absolute;bottom:0; z-index: 1000;width: 100%;" class="alert alert-info" role="alert" data-bs-theme="dark">
  ...
  <div class="container-fluid body-container">
    ...
    <div class="tool_bar">
      <button type="button" id="network_btn" onclick="appBarBtn(0)" class="btn btn-outline-dark btn-sm my-btn-outline my-btn-selected">
        ...
        <span  class="toolbar_icon_label">Network </span>
      </button>
      <button type="button" id="log_btn" onclick="appBarBtn(1)" class="btn btn-outline-dark btn-sm my-btn-outline">
        <span class="material-symbols-outlined">terminal</span>
        <span  class="toolbar_icon_label">Logs </span>
      </button>
      <!-- online -->
      <div id="online_status" class="online_box"> </div>
      <button type="button" id="log_btn" onclick="downloadHtml()" class="btn btn-outline-dark btn-sm my-btn-outline">
        <span class="material-symbols-outlined">download</span>
        <span  class="toolbar_icon_label">Download </span>
      </button>
      <button type="button"    onclick="onClearButtonClick()" class="btn btn-outline-dark btn-sm my-btn-outline">
        <span class="material-symbols-outlined">block</span>
        <span class="toolbar_icon_label">clear</span>
      </button>
    </div>
    <!-- logger container -->
